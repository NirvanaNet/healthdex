        ...
        <div className="w-[50vw] h-[100%] m-10 flex justify-center items-center border rounded-lg border-gray-500">
          <div className="w-[80%] h-[100%] px-6 py-6 sm:px-0 ">
                ...
                <Tab.Panel className=" ">
                  <div className="w-full h-[100%] bg-black rounded-md mt-15 flex justify-center items-center">
                    <form className="text-white h-[100%] mt-15 p-5 ml-8 w-full  ">
                      ...
                      />
                      <label className="block mt-5">Doctor Name</label>
                      <input
                        type="text"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                        placeholder="Enter your full name"
                      />
                      <label className="block mt-5">Specialization</label>
                      <input
                        type="text"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                        placeholder="What is your specialization "
                      />
                      <label className="block mt-5">Address</label>
                      <input
                        type="text"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                        placeholder="Enter your address"
                      />
                      <label className="block mt-5">Contact Number</label>
                      <input
                        type="text"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                      ...
                      />
                      <label className="block mt-5">Create Password</label>
                      <input
                        type="password"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                  ...
                  <div className="w-[100%] h-[100%] bg-black rounded-md mt-15 ">
                    <form className="text-white h-[100%] mt-15 p-5 ml-8 w-full">
                      ...
                      <input
                        ...
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
                      />
                      <label className="block mt-5">Patient Name</label>
                      <input
                        type="text"
                        className="bg-gray-800 block mt-3 w-full text-white  rounded outline-none p-2"
            ...
            <div className="flex justify-center items-center">
              ...
              <p>already have an account? <Link href="/signin" className="underline text-primary ">sign in here </Link> </p>
            </div>
          </div>
        </div>
      </section>
