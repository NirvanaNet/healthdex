        ...
        <header className=" border-gray-100 pt-2 ">
            <div className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 items-center justify-end gap-8">
                    <nav
                        aria-label="Global"
                        className="hidden lg:flex lg:gap-5 lg:text-[1rem] font-bold lg:tracking-wider lg:text-white-500 items-center"
                    >
                        <Link
                            href="/about"
                        ...
                        <button className="block w-[30px] h-[30px] bg-slate-200 rounded-full"></button>
                    </nav>
                </div>
            </div>
        </header>
